...
def solve_subproblems(data,sample,investments):
...
def solve_with_benders(data, sample):
    ...
    while not optimal:
        ...
        obj_val_total, dual_val_all  = solve_subproblems(data,sample,investments_iter_k)
